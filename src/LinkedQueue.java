...
* @see ArrayQueue
******************************************************************************/
public class LinkedQueue<E> implements Cloneable, QueueInterface<E>
{
   ...
   **/ 
   ...
   /**
   * Get the front item of this queue, without removing the item.
   * @param - none
   * <dt><b>Precondition:</b><dd>
   *   This queue is not empty.
   * @return
   ...
   * @exception NoSuchElementException
   *   Indicates that this queues is empty.
   **/   
   public E peek() {
    if (isEmpty())
     return null;
